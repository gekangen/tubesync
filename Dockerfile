...
ARG FFMPEG_DATE="autobuild-2024-10-01-14-12"
ARG FFMPEG_VERSION="117286-g262e6f8430"
...
RUN export ARCH=$(case ${TARGETPLATFORM:-linux/amd64} in \
  ...
  *)               echo ""        ;; esac) && \
  ...
  "linux/amd64")   echo "aae24a89be703366ec4f717336bdcc20f5624cd717b2d5b1a78f65be047e1d0a" ;; \
  "linux/arm64")   echo "63501f3d8b339ee5a64f34ca9308825097b772e05fe56b739daee28ae4f746df" ;; \
  *)               echo ""        ;; esac) && \
